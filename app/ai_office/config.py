...
NEWS_FILTER_PROMPT = (
    ...
    "1. Относятся к 5 лигам: EPL, La Liga, Serie A, Bundesliga, Ligue 1\n"
    "2. Содержат полезную для прогнозов информацию:\n"
...
NEWS_WRITER_PROMPT = (
    ...
    "Входные данные: заголовок и описание из RSS-фида (английский).\n\n"
    ...
    "Даже если источник на английском — пиши на русском.\n"
